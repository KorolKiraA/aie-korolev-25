...
- **Название проекта:** `Прогнозирование розничных продаж с учетом сезонности и промо-акций`
- **Автор:** `Королев Кирилл Александрович`
- **Группа:** `ИКБО-24-22`
- **Контакт:** `korol354000@gmail.com`

- **Краткое описание (2-4 предложения):**  
  `Проект посвящен разработке системы прогнозирования объемов продаж для розничной сети с горизонтом прогноза 30 дней. Используются исторические данные о продажах, календарная информация и данные о промо-акциях. Применяются методы машинного обучения (LightGBM, XGBoost), статистические модели (Prophet, ARIMA) и нейронные сети (LSTM). Результат – веб-интерфейс с визуализацией прогнозов и API для интеграции с системами управления запасами.`
